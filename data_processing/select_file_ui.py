...
class SelectFileUI(QWidget):
    def __init__(self):
        super().__init__()
        self.initUI()
        self.file_name = "ai_acquired_data"
        self.file_dir = ""
    ...
    def initUI(self):
        ...
        self.key_name.textChanged.connect(self.file_name_changed)
        ...
        layout.addWidget(self.find_file_name, 3, 0)
    ...
    def file_name_changed(self):
        self.file_name = self.find_file_name.text()
